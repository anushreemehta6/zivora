...
import { Gift, Package, MessageSquare, Truck, Sparkles, ArrowRight, Contact } from "lucide-react";
...
export default function GiftingSection() {
   return (
      <section className="bg-secondary w-full py-12 text-white overflow-hidden relative">
         {/* Decorative Blur */}
         ...
         <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative group">
               <div className="relative h-[500px] rounded-[4rem] overflow-hidden shadow-2xl transition-transform duration-700 group-hover:scale-[0.98]">
                  <Image
                     src={giftingBg}
            ...
            <div className="space-y-10 lg:pl-10">
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 py-2">
                  ...
                  <div className="flex gap-4">
                     <Contact size={24} className="text-primary shrink-0" />
                     <div>
                        <h4 className="font-bold text-sm mb-1">Expert Assistance</h4>
               ...
               <div className="flex gap-4 pt-6">
                  <Link href="/products?tag=best-sellers">
                     <Button variant="outlinewhite" className="px-10 py-5 text-sm font-bold uppercase tracking-widest shadow-2xl shadow-primary/20">Explore Gift Sets</Button>
                  </Link>
                  <Link href="/gifting">
                     <Button variant="outlinewhite" className="px-10 py-5 text-sm font-bold uppercase tracking-widest ">Learn More</Button>
                  </Link>
               </div>
            </div>
         </div>
